...
namespace asylo {
    ...
    class EnclaveDemo : public TrustedApplication {
    	public:
    		...
    		Status Run(const EnclaveInput &input, EnclaveOutput *output) {
    			...
    			case guide::asylo::Demo::SHA1: {
    				SetEnclaveOutputMessage(output, Sha1(user_message));
    				break;
    			}
    			case guide::asylo::Demo::SHA512: {
    				SetEnclaveOutputMessage(output, Sha512(user_message));
    			break;
    			}
    			case guide::asylo::Demo::MD5: {
    				SetEnclaveOutputMessage(output, Md5(user_message));
    			break;
    			}
    			...
    			case guide::asylo::Demo::DH: {
    				CreateDiffieHellman();
    				SetEnclaveOutputMessage(output, "Diffie Hellman Done");				
    			break;
    			}
    			default:
    				SetEnclaveOutputMessage(output, "ERROR - ON SWITCH");			
    		}
      ...
      // used by the reader for completing the exercise.
    		...
    		guide::asylo::Demo *output = enclave_output->MutableExtension(guide::asylo::quickstart_output);
